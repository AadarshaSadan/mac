...
try {                  // Enable verbose debug output
   ...
   // Optional name
    ...
    $mail->Body    =  " Hello, <b>Dr. Jhon doe  </b>, Please verify the application details followed by this link<b>http://localhost/mac/refere/refree_conform.php?userid=".$userid."&jobid=".$jobid."</b> at $date<br/><br/>Regards,<br/>Macs Technology";
